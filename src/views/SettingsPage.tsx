                  ...
                  <div className="flex items-center space-x-4 rtl:space-x-reverse">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-gray-500 dark:text-gray-400">
                        {user?.role === 'admin' ? t('navigation.settings.adminUser') : t('navigation.settings.regularUser')}
                      </p>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600 dark:text-gray-400">{t('navigation.version')}:</span>
                      <span className="font-medium">1.0.0</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600 dark:text-gray-400">{t('navigation.settings.status')}</span>
                      <span className="font-medium text-green-600">{t('navigation.settings.workingNormally')}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-600 dark:text-gray-400">{t('navigation.settings.lastUpdate')}</span>
