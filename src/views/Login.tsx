...
import { login, loginStart, loginFailure, authenticateUser, generateToken } from '../slices/authSlice';
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    try {
      ...
      if (user) {
        ...
        success(t('messages.loginSuccessTitle'), t('messages.loginSuccessMessage'));
        navigate('/home');
      } else {
