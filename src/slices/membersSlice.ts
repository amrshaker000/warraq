...
export const addMember = createAsyncThunk('members/addMember', async (member: Omit<Member, 'id' | 'createdAt' | 'updatedAt'>) => {
  const newMember = {
    ...member,
...
export const updateMember = createAsyncThunk('members/updateMember', async ({ id, member }: { id: string; member: Partial<Member> }) => {
...
export const searchMembers = createAsyncThunk('members/searchMembers', async (query: string) => {
  return CsvService.getInstance().searchMembers(query);
});

export const filterMembers = createAsyncThunk('members/filterMembers', async (filters: {
  gender?: string;
  status?: string;
...
export const getMemberStats = createAsyncThunk('members/getMemberStats', async () => {
  return CsvService.getInstance().getMemberStats();
});

export const importMembers = createAsyncThunk('members/importMembers', async (members: Member[]) => {
...
export const { setSearchQuery, setFilters, clearFilters, clearError, restoreMembers } = membersSlice.actions;
