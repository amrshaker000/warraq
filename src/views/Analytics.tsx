...
const Analytics: React.FC = () => {
  ...
  const { list: members, stats } = useSelector((state: RootState) => state.members);
  ...
  const fetchData = useCallback(() => {
    const params = {
      ...
      ...(filters.financialStatus !== 'all' && { financialStatus: filters.financialStatus }),
    };
  ...
  const filteredMembers = members.filter((member: Member) => {
    ...
    const matchesFinancialStatus = 
      ...
      (filters.financialStatus === 'paid' ? member.financialSupport === 'paid' : member.financialSupport === 'unpaid');
    ...
    <div className="min-h-screen flex bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex-1 flex flex-col transition-all duration-300 ease-in-out">
        ...
        <main className="flex-1 p-4 lg:p-6">
          {/* Header and Filters */}
          <AnimatedSection className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6 space-y-4 lg:space-y-0" delay={0.1}>
          ...
          {/* Tabs */}
          <AnimatedSection className="border-b border-gray-200 dark:border-gray-700 mb-6" delay={0.2}>
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <span className="text-xs font-medium text-green-600 dark:text-green-400 bg-green-100 dark:bg-green-900/30 px-2 py-0.5 rounded-full">
                      {activeMembersPercentage.toFixed(1)}% {t('analytics.ofTotal')}
                    </span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <span className="text-xs font-medium text-yellow-600 dark:text-yellow-400 bg-yellow-100 dark:bg-yellow-900/30 px-2 py-0.5 rounded-full">
                      {paidMembersPercentage.toFixed(1)}% {t('analytics.paidRate')}
                    </span>
                  </div>
                </div>
          ...
          {activeTab === 'overview' && (
            <div className="space-y-8">
              ...
              <Card className="p-6">
                ...
                <div className="h-80">
                  <RegistrationTrendChart members={members} dateRange={dateRange} />
                </div>
              </Card>
              ...
              <Card className="p-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <div className="h-64">
                      <RegistrationTrendChart members={filteredMembers} dateRange={dateRange} />
                    </div>
                  </div>
                </div>
              </Card>
