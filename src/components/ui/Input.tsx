        ...
        {leftIcon && (
          <div className="absolute inset-y-0 left-0 pl-4 flex items-center">
            <div className="p-1.5 rounded-lg bg-blue-50 dark:bg-blue-900/30">
              <span className="text-blue-600 dark:text-blue-400 [&>button]:pointer-events-auto">{leftIcon}</span>
            </div>
          </div>
        )}
        ...
        {rightIcon && (
          <div className="absolute inset-y-0 right-0 pr-4 flex items-center">
            <div className="p-1.5 rounded-lg bg-blue-50 dark:bg-blue-900/30 hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors duration-200">
              <span className="text-blue-600 dark:text-blue-400 [&>button]:pointer-events-auto">{rightIcon}</span>
            </div>
          </div>
        )}
      </div>
