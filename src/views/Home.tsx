...
const Home: React.FC = () => {
  ...
  const statCards = useMemo(() => [
    ...
    },
    {
      ...
      description: t('dashboard.newRegistrations', { count: safeStats.recentRegistrations })
    },
  ], [safeStats, t]);
    ...
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex-1 flex flex-col transition-all duration-300 ease-in-out">
        ...
        <main className="flex-1 overflow-y-auto">
          ...
          {/* Hero Section */}
          <AnimatedSection className="relative bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-800 dark:to-purple-900 text-white py-20 lg:py-32" delay={0.1}>
          ...
          {/* Stats Section */}
          <AnimatedSection className="py-16 lg:py-24 bg-gray-50 dark:bg-gray-800" delay={0.2}>
          ...
          <AnimatedSection className="py-16 lg:py-24 bg-gradient-to-r from-blue-600 to-purple-600 text-white" delay={0.4}>
          ...
          <AnimatedSection className="py-16 lg:py-24 bg-white dark:bg-gray-900" delay={0.6}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <Card className="p-8">
                <AnimatedGroup
                  staggerDelay={0.2}
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-lg">
                      {safeStats.recentRegistrations > 0
                        ? t('dashboard.newRegistrations', { count: safeStats.recentRegistrations })
